...
class AdminStates(StatesGroup):
    ...
    system_menu = State()  # Меню «Настройки бота»
    settings_list = State()  # Список настроек (редактирование)
    edit_setting_toggle = State()  # Переключение настройки вкл/выкл
    bot_stats = State()  # Экран статистики
    update_check = State()  # Проверка обновлений
    ...
    # ========== Автоуведомления ==========
    notify_days = State()            # Ожидание числа дней для уведомления
    notify_text = State()            # Ожидание текста уведомления
    ...
    add_key_tariff = State()         # Выбор тарифа
